...
def eliminar_comentarios(archivo_entrada: str, archivo_salida: str) -> None:
    ...
    Args:
    - archivo_entrada (str): Nombre del archivo de entrada que contiene el código Python.
    - archivo_salida (str): Nombre del archivo donde se guardará el código sin comentarios.
    """
